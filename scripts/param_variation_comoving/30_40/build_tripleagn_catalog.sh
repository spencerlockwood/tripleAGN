...
OUTPUT='/scratch/stlock/tripleAGNs/outputs/30_40/'

# Run the Python script and redirect output
python -u /home/stlock/tripleAGN/scripts/param_variation_comoving/30_40/build_tripleagn_catalog.py ${SLURM_ARRAY_TASK_ID} &> ${OUTPUT}/output_${SLURM_JOB_ID}.log