#!/bin/bash -l
#########################################################
#SBATCH -J 100_43_BuildTripleAGN
...
OUTPUT='/scratch/stlock/tripleAGNs/outputs/100_43/'

# Run the Python script and redirect output
python -u /home/stlock/tripleAGN/scripts/param_variation_comoving/100_43/build_tripleagn_catalog.py ${SLURM_ARRAY_TASK_ID} &> ${OUTPUT}/output_${SLURM_JOB_ID}.log