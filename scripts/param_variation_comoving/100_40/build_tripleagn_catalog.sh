#!/bin/bash -l
#########################################################
#SBATCH -J 100_40_BuildTripleAGN
...
OUTPUT='/scratch/stlock/tripleAGNs/outputs/100_40/'

# Run the Python script and redirect output
python -u /home/stlock/tripleAGN/scripts/param_variation_comoving/100_40/build_tripleagn_catalog.py ${SLURM_ARRAY_TASK_ID} &> ${OUTPUT}/output_${SLURM_JOB_ID}.log