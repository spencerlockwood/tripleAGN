...
##############################################
def find_triple_agn_systems(df, sim, t_now, t_prev, separation_threshold=100, mdot_threshold=1.89e-3, z=None):
    ...
    agn_bhs = df[df['BH_Lbol'] > 1e40].copy()
...
def main(snapshot_index):
    ...
    output_path = "/scratch/stlock/tripleAGNs/catalogs/1e40lum/catalogue_100kpc_1e40lum/TripleAGN-Catalog-R50-z{:.2f}.pkl"
