...
OUTPUT='/scratch/stlock/tripleAGNs/outputs_100_43/'

# Run the Python script and redirect output
python -u /home/stlock/tripleAGN/scripts/build_tripleagn_catalog_100_43.py ${SLURM_ARRAY_TASK_ID} &> ${OUTPUT}/output_${SLURM_JOB_ID}.log