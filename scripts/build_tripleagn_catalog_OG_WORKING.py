...
##############################################
def find_triple_agn_systems(df, sim, t_now, t_prev, separation_threshold=15, mdot_threshold=1.89e-3, z=None):
    ...
    agn_bhs = df[df['BH_Lbol'] > 1e41].copy()
...
def main(snapshot_index):
    ...
    output_path = "/scratch/stlock/tripleAGNs/catalogs/1e41lum/catalogue_15kpc_1e41lum/TripleAGN-Catalog-R50-z{:.2f}.pkl"
