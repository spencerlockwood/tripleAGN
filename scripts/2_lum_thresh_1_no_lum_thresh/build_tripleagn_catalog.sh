#!/bin/bash -l
#########################################################
#SBATCH -J 2lum_1nolum_BuildTripleAGN
...
OUTPUT='/scratch/stlock/tripleAGNs/outputs/2lum_1notlum/'

# Run the Python script and redirect output
python -u /home/stlock/tripleAGN/scripts/2_lum_thresh_1_no_lum_thresh/build_tripleagn_catalog.py ${SLURM_ARRAY_TASK_ID} &> ${OUTPUT}/output_${SLURM_JOB_ID}.log